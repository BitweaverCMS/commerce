...
{if $smarty.get.action == 'doneprocess'}
	<div class="control-group submit">
		...
		{forminput}
			...
			<input type="submit" name="" value="{tr}Send More Certificates{/tr}" />
			</form>
		{/forminput}
	</div>
{elseif $smarty.get.action == 'send' && !$feedback.error}
	...
	<div class="control-group submit">
		<input type="submit" name="action" value="{tr}Back{/tr}" />
        <input type="submit" name="action" value="{tr}Process{/tr}" />
	</div>
    </form>
{elseif !$smarty.get.action || $feedback.error}
	...
	<div class="control-group submit">
        <input type="submit" name="send_now" value="{tr}Send{/tr}" />
	</div>
	</form>
