...
<td class="dataTableContent" align="right" valign="top">{$currencies->format($ordersProduct.final_price,true,$order->info.currency, $order->info.currency_value)}{if $order->info.currency && $order->info.currency != $smarty.const.DEFAULT_CURRENCY} /{$currencies->format($ordersProduct.final_price,true,$smarty.const.DEFAULT_CURRENCY)}{/if}
	{if $ordersProduct.onetime_charges}<br />{$currencies->format($ordersProduct.onetime_charges, true, $order->info.currency, $order->info.currency_value)}}{if $order->info.currency && $order->info.currency != $smarty.const.DEFAULT_CURRENCY} /{$currencies->format($ordersProduct.onetime_charges,true,$smarty.const.DEFAULT_CURRENCY)}{/if}{/if}
...
{if $ordersProduct.tax}
	...
	{if $ordersProduct.onetime_charges}
		...
		{if $ordersProduct.onetime_charges != $onetimePlusTax}
			<br /> {$currencies->format($onetimePlusTax,true,$order->info.currency,$order->info.currency_value)}{if $order->info.currency && $order->info.currency != $smarty.const.DEFAULT_CURRENCY} /{$currencies->format($onetimePlusTax,true,$smarty.const.DEFAULT_CURRENCY)}{/if}
		{/if}
	{/if}
{/if}
</td>
<td class="dataTableContent" align="right" valign="top">
	...
	{$currencies->format($finalQty, true, $order->info.currency, $order->info.currency_value)}{if $order->info.currency && $order->info.currency != $smarty.const.DEFAULT_CURRENCY} /{$currencies->format($finalQty,true,$smarty.const.DEFAULT_CURRENCY)}{/if}
