	...
	<td class="supplemental" colspan="">
		...
		{section loop=$ordersProduct.attributes name=a}
				<li class="orders products attributes" id="{$ordersProduct.attributes[a].products_attributes_id}att">
					<a class="icon" href="{$smarty.server.REQUEST_URI}&amp;del_ord_prod_att_id={$ordersProduct.attributes[a].orders_products_attributes_id}" onclick="return deleteOption({$ordersProduct.attributes[a].orders_products_attributes_id},'{$ordersProduct.attributes[a].products_options_name|escape:'quotes'|escape:'htmlall'}: {$ordersProduct.attributes[a].products_options_values_name|escape:'quotes'|escape:'htmlall'}');"><i class="fa fal fa-trash"></i></a> <small>{$ordersProduct.attributes[a].products_options_name}: {$ordersProduct.attributes[a].products_options_values_name} ({$ordersProduct.attributes[a].products_options_values_id})
