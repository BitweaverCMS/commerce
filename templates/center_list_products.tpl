...
{foreach name=listedProducts from=$listedProducts item=prod key=productId}
    <div class="col-sm-4 col-xs-6">
		<span class="productimage"><a href="{CommerceProduct::getDisplayUrlFromHash($prod)}" /><img class="img-responsive img-thumbnail" src="{$prod.products_image_url}"/></a></span>
		...
		<div class="buynow pull-right"><a class="btn btn-default btn-xs" href="{CommerceProduct::getDisplayUrlFromHash($prod)}">{tr}Buy Now{/tr}</a></div>
		<div class="details">
