...
{/if}
<div class="control-group {if $addressErrors.firstname}error{/if}">
...
<div class="control-group {if $addressErrors.lastname}error{/if}">
...
{/if}
<div class="control-group {if $addressErrors.street_address}error{/if}">
...
{/if}
<div class="control-group {if $addressErrors.city}error{/if}">
...
<div class="control-group {if $addressErrors.state}error{/if}">
...
{/if}
<div class="control-group {if $addressErrors.postcode}error{/if}">
...
<div class="control-group {if $addressErrors.country_id}error{/if}">
...
<div class="control-group {if $addressErrors.telephone}error{/if}">
