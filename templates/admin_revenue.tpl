...
<div class="admin bitcommerce">
	...
	<tr>
		...
		<td class="item {$oddeven}" style=""><span style="background:#fed;display:inline-block;width:{math equation="round(100*(count/max))" count=$statsCustomers.$statKey.new_customers_that_purchased_new_products max=$statsCustomers.max_stats.new_customers_that_purchased_new_products}%">{$statsCustomers.$statKey.new_customers_that_purchased_new_products}</span><span class="floatright">({math equation="round(100*(pur/cre))" pur=$statsCustomers.$statKey.new_customers_that_purchased_new_products cre=$statsCustomers.$statKey.new_customers_that_created_products}%)</span></td>
