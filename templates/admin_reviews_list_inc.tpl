...
<span class="pl-2"><a href="{$smarty.const.BITCOMMERCE_PKG_ADMIN_URL}reviews.php?customers_id={$review.customers_id}">{$review.real_name|default:$review.login}</a> <span class="date">"{$review.reviewers_name}"</span> </span>
