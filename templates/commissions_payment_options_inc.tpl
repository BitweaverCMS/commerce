{form method="post" enctype="multipart/form-data" action=$smarty.server.REQUEST_URI}
	...
	<div class="control-group" id="commissionstorecredit"> 
		{formlabel label=""}
		{forminput}
		{/forminput}
	</div>
	<div class="control-group" id="commissionpaypal"> 
	...
	<div class="control-group" id="commissionworldpay"> 
	...
	<div class="control-group" id="commissioncheck"> 
