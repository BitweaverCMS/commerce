{fieldset legend="Order Deadline"}
	<div class="input-group date" id="order-deadline">
		<input type="text" class="form-control" name="deadline_date" value="{$deadline|date_format:'Y-m-d'}"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
	</div>
