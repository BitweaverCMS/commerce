{fieldset legend="Order Deadline"}
	...
	{formhelp note="If you have an urgent deadline to receive your order, enter it here like 2023-04-01. <br><strong>This is not a guarantee</strong>, but will let us know if it can be delivered in time."}
{/fieldset}
<script>
