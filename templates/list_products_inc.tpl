...
{else}
	...
	{elseif $listInfo.page-$listInfo.block_pages > 0}
	...
	{/if}
	{/section}
	{if $blockStart+$listInfo.block_pages*2 < $listInfo.total_pages} <a href="{$pageUrl}&page={$listInfo.page+$listInfo.block_pages}">...</a>  <a href="{$pageUrl}&page={$listInfo.total_pages}">{$listInfo.total_pages}</a>{/if}
