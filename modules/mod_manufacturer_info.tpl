...
<a href="{$smarty.const.BITCOMMERCE_PKG_URL}index.php?main_page=redirect&action=manufacturer&manufacturers_id={$sideboxManufacturerInfo.manufacturers_url}" target="_blank">{$sideboxManufacturerInfo.manufacturers_name}</a>
{/if}
{/bitmodule}
{/if}