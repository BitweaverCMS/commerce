...
{elseif $writeReview}
<a href="{$smarty.const.BITCOMMERCE_PKG_URL}index.php?main_page=product_reviews_write&products_id={$sideboxReview.products_id}">{tr}Write a review on this product.{/tr}</a>
