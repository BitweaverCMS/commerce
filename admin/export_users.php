<?php
   require_once '../../bit_setup_inc.php';
	...
	$query = "SELECT email,real_name,user_id,cab.*,MAX(date_purchased) as last_purchase FROM users_users uu
   ...
   header("Content-disposition: filename=users_export" . date("Y-m-d") . ".xls");
   print $csv_output;
   exit;  
?>
