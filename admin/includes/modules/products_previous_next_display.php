...
// +----------------------------------------------------------------------+
//  $Id: products_previous_next_display.php,v 1.3 2005/08/11 04:36:37 spiderr Exp $
//
...
<!-- bof: products_previous_next_display -->
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="3" class="main" align="left"><?php echo (zen_get_categories_status($current_category_id) == '0' ? TEXT_CATEGORIES_STATUS_INFO_OFF : '') . (zen_get_products_status($productsId) == '0' ? ' ' . TEXT_PRODUCTS_STATUS_INFO_OFF : ''); ?></td>
      </tr>
      <tr>
