...
define('TEXT_INFO_CAUTION','Note: you should always edit the files located in your current template override directory, Example: /languages/' . $gBitCustomer->getLanguage() . '/html_includes/' . $gCommerceSystem->mTemplateDir . '<br />Be sure to make backups after changing your files.');
?>
