...
<div class="col-md-8">
	...
	<caption><?php echo tra('Edit Layout' ).': '.$productTypeHash['type_name'] ?></caption>
	<tr>
		<th width="55%"><?php echo TABLE_HEADING_CONFIGURATION_TITLE; ?></th>
...
<div class="col-md-8">
	...
	<tr class="dataTableHeadingRow">
		...
		<th class="text-center"><?php echo TABLE_HEADING_PRODUCT_TYPES_ALLOW_ADD_TO_CART; ?></th>
...
?>
	...
	<div class="small pull-left"><?php echo $product_types_split->display_count($product_types_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_PRODUCT_TYPES); ?></div>
	<div class="small pull-right"><?php echo $product_types_split->display_links($product_types_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?></div>
</div>
<div class="col-md-4">
<?php
	$heading = array();
	...
	switch ($action) {
		...
		case 'edit':
			...
			$contents[] = array('text' => TEXT_EDIT_INTRO);
			$contents[] = array('text' => TEXT_PRODUCT_TYPES_NAME . '<br>' . zen_draw_input_field('type_name', $ptInfo->type_name, zen_set_field_length(TABLE_PRODUCT_TYPES, 'type_name')));
			$contents[] = array('text' => TEXT_PRODUCT_TYPES_IMAGE . '<br>' . zen_draw_file_field('default_image') . '<br />' . $ptInfo->default_image);
			...
			$contents[] = array('text' => TEXT_PRODUCT_TYPES_HANDLER . '<br>' . zen_draw_input_field('handler', $ptInfo->type_handler, zen_set_field_length(TABLE_PRODUCT_TYPES, 'type_handler')));
			$contents[] = array('text' => zen_draw_checkbox_field('catalog_add_to_cart', $ptInfo->allow_add_to_cart, ($ptInfo->allow_add_to_cart == 'Y' ? true : false), null, TEXT_PRODUCT_TYPES_ALLOW_ADD_CART));
