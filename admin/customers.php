...
<?php
  ...
  switch ($action) {
    case 'confirm':
      ...
      $contents = array('form' => zen_draw_form_admin('customers', FILENAME_CUSTOMERS, zen_get_all_get_params(array('cID', 'action')) . 'cID=' . $cInfo->customers_id . '&action=deleteconfirm', 'post', '', true));
