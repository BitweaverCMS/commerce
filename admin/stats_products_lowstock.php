...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='<?php echo zen_href_link_admin($type_handler, '&product_type=' . $products->fields['products_type'] . '&cPath=' . $cPath . '&products_id=' . $products->fields['products_id'] . '&action=new_product'); ?>'">
                <td class="dataTableContent" align="right"><?php echo $products->fields['products_id']; ?>&nbsp;&nbsp;</td>
                <td class="dataTableContent"><?php echo '<a href="' . zen_href_link_admin(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&products_id=' . $products->fields['products_id']) . '">' . $products->fields['products_name'] . '</a>'; ?></td>
