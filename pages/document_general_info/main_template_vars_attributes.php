...
// +----------------------------------------------------------------------+
// $Id: main_template_vars_attributes.php,v 1.8 2007/01/06 06:13:51 spiderr Exp $
//
//////////////////////////////////////////////////
//// BOF: attributes
//////////////////////////////////////////////////
...
// reverse negative values for display
            ...
            if ($products_options->fields['attributes_price_onetime'] != 0 or $products_options->fields['attributes_pf_onetime'] != 0) {
              ...
              $new_onetime_charges = zen_get_attributes_price_final_onetime((int)$_GET['products_id'],$products_options->fields["products_options_vales_id"], 1, '');
...
// collect weight information if it exists
          if ((SHOW_DOCUMENT_GENERAL_INFO_WEIGHT_ATTRIBUTES=='1' and $products_options->fields['products_attributes_wt'] != '0')) {
