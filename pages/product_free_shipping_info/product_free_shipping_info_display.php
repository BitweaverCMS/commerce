...
// base price
  ...
  echo $one_time . (($gBitProduct->hasAttributes() and SHOW_PRODUCT_FREE_SHIPPING_INFO_STARTING_AT == '1') ? TEXT_BASE_PRICE : '') . $gBitProduct->__getDisplayPrice();
?>
    </td>
  </tr>
      ...
      <table border="0" width="150px" cellspacing="2" cellpadding="2">
        <tr>
          <td align="center" class="cartBox">
            <?php echo ((SHOW_PRODUCT_FREE_SHIPPING_INFO_IN_CART_QTY == '1' and $gBitCustomer->mCart->in_cart($_GET['products_id'])) ? PRODUCTS_ORDER_QTY_TEXT_IN_CART . $gBitCustomer->mCart->get_quantity($_GET['products_id']) . '<br /><br />' : '&nbsp;'); ?>
            <?php
