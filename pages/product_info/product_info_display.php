...
// +----------------------------------------------------------------------+
// $Id: product_info_display.php,v 1.13 2009/08/12 21:04:08 spiderr Exp $
//
...
// base price
  ...
  echo '<h2>' . $one_time . (($gBitProduct->hasAttributes() and SHOW_PRODUCT_INFO_STARTING_AT == '1') ? TEXT_BASE_PRICE : '') . $gBitProduct->getDisplayPrice() . '</h2>';
?>
	</div>
<?php
...
?>
	<div class="row">
      <table border="0" style="width:150px" cellspacing="2" cellpadding="2">
        <tr>
          <td>
            <?php echo ((SHOW_PRODUCT_INFO_IN_CART_QTY == '1' and $gBitCustomer->mCart->in_cart($_GET['products_id'])) ? PRODUCTS_ORDER_QTY_TEXT_IN_CART . $gBitCustomer->mCart->get_quantity($_GET['products_id']) . '<br /><br />' : '&nbsp;'); ?>
            <?php
