...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// P2.1: bare URL = newest; crawl/canonical = created_asc (see CommerceProduct::applyListCrawlSeo)
	if( empty( $_REQUEST['sort_mode'] ) ) {
		$_REQUEST['sort_mode'] = CommerceProduct::LIST_HUMAN_SORT;
	}
	if( empty( $_REQUEST['max_records'] ) ) {
		$_REQUEST['max_records'] = CommerceProduct::LIST_DEFAULT_MAX_RECORDS;
	}

	$listProducts = $gBitProduct->getList( $_REQUEST );
	CommerceProduct::applyListCrawlSeo( $_REQUEST );
