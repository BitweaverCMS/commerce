...
// +----------------------------------------------------------------------+
// $Id: shopping_cart.php,v 1.16 2008/02/08 04:43:06 spiderr Exp $
//
?>
...
//          echo zen_draw_hidden_field('id[' . $products[$i]['id'] . '][' . $option . ']', $value);
          ...
          $attributes_values = $gBitDb->query($attributes, array( $prid, $optionId, (int)$value, $_SESSION['languages_id'] ) );
