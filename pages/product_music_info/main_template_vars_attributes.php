...
// +----------------------------------------------------------------------+
// $Id: main_template_vars_attributes.php,v 1.13 2009/08/18 20:32:09 spiderr Exp $
//
//////////////////////////////////////////////////
//// BOF: attributes
//////////////////////////////////////////////////
...
// reverse negative values for display
            ...
            if ($products_options->fields['attributes_price_onetime'] != 0 or $products_options->fields['attributes_pf_onetime'] != 0) {
              ...
              $new_onetime_charges = $gBitProduct->getAttributesPriceFinalOnetime( $products_options->fields["products_options_values_id"] );
...
// collect weight information if it exists
          if ((SHOW_PRODUCT_MUSIC_INFO_WEIGHT_ATTRIBUTES=='1' and $products_options->fields['products_attributes_wt'] != '0')) {
