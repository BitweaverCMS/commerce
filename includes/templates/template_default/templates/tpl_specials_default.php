...
// +----------------------------------------------------------------------+
// $Id: tpl_specials_default.php,v 1.5 2005/07/14 04:55:16 spiderr Exp $
//
?>
...
<?php
    ...
    while (!$specials->EOF) {
      ...
      echo '            <td valign="bottom" align="center" width="33%" class="smallText"><a href="' . zen_href_link(zen_get_info_page($specials->fields['products_id']), 'products_id=' . $specials->fields['products_id']) . '">' . zen_image( CommerceProduct::getImageUrl( $specials->fields['products_image'] ), $specials->fields['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br /><a href="' . zen_href_link(zen_get_info_page($specials->fields['products_id']), 'products_id=' . $specials->fields['products_id']) . '">' . $specials->fields['products_name'] . '</a><br />' . zen_get_products_display_price($specials->fields['products_id']) . '</td>' . "\n";
