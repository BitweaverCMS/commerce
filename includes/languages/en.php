...
define('DATE_FORMAT_LONG', 'l d F, Y'); // this is used for date()
...
define('WARNING_SESSION_DIRECTORY_NON_EXISTENT', 'Warning: The sessions directory does not exist: ' . session_save_path() . '. Sessions will not work until this directory is created.');
define('WARNING_SESSION_DIRECTORY_NOT_WRITEABLE', 'Warning: I am not able to write to the sessions directory: ' . session_save_path() . '. Sessions will not work until the right user permissions are set.');
