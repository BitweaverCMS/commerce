...
define('HEADING_TEXT','Please enter below the details of the ' . TEXT_GV_NAME . ' you wish to send. For more information, please see our <a href="' . zen_href_link(FILENAME_GV_FAQ, '', tra( 'NONSSL').'">' . GV_FAQ . '.</a>' ) );
