...
// +----------------------------------------------------------------------+
// $Id: reviews.php,v 1.2 2005/07/30 03:01:58 spiderr Exp $
//
...
// if review must be approved or disabled do not show review
  ...
  $random_review_sidebox_select = "select r.reviews_id, r.reviews_rating, rd.reviews_text, p.products_id, p.products_image, pd.products_name $selectSql
                    from " . TABLE_REVIEWS . " r, " . TABLE_REVIEWS_DESCRIPTION . " rd, "
                           . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd $fromSql
...
//    $review_box_text = zen_break_string(zen_output_string_protected($review_box_text->fields['reviews_text']), 15, '-<br />');
    $review_box_text = zen_break_string(nl2br(zen_output_string_protected(stripslashes($random_review_sidebox_product->fields['reviews_text']))), 60, '-<br />');
...
// display 'no reviews' box
  ...
  $title =  '<img src="'.BITCOMMERCE_PKG_URL.'icons/star.png" alt="*" />'.BOX_HEADING_REVIEWS;
  $left_corner = false;
  $right_corner = false;
  $right_arrow = false;
