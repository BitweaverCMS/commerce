...
// +----------------------------------------------------------------------+
// $Id: column_right.php,v 1.2 2005/07/30 15:59:38 spiderr Exp $
//
	global $moduleTitle;
	...
	while (!$column_right_display->EOF and $box_cnt < 100) {
		...
		print $gBitSmarty->fetch( "bitpackage:bitcommerce/mod_".str_replace( '.php', '.tpl', $column_right_display->fields['layout_box_name'] ) );
