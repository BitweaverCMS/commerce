<?
/*
  $Id: specialdelivery.php,v 1.4 2009/08/26 21:10:43 spiderr Exp $
  based upon
  $Id: specialdelivery.php,v 1.4 2009/08/26 21:10:43 spiderr Exp $
  based upon
  $Id: specialdelivery.php,v 1.4 2009/08/26 21:10:43 spiderr Exp $
...
// class constructor
    function specialdelivery() {
      ...
      $this->icon = 'shipping_sdnd.gif';
		if( defined( 'MODULE_SHIPPING_SPECIALDELIVERY_STATUS' ) ) {
      ...
      if ($dest_zone == 0) {
	   ...
	   //12 FEB 04 MBeedell	'glue' together the rates from the 10 cost data entry boxes
        ...
        if ($shipping == -1) {
          ...
          $shipping_cost = ($shipping * $shippingNumBoxes) + constant('MODULE_SHIPPING_SPECIALDELIVERY_ZONES_HANDLING_' . $dest_zone);
        }
      }
