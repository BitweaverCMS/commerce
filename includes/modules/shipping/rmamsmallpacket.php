<?
/*
  $Id: rmamsmallpacket.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
  based upon
  $Id: rmamsmallpacket.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
  based upon
  $Id: rmamsmallpacket.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
...
//                            'module' => MODULE_SHIPPING_RMAMSMALLPACKET_TEXT_TITLE ,
    ...
    global $db;
      if (!isset($this->_check)) {
        $check_query = $db->Execute("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_SHIPPING_RMAMSMALLPACKET_STATUS'");
    ...
    global $db;
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_RMAMSMALLPACKET_SORT_ORDER', '0', 'Sort order of display.', '6', '0', now())");
...
// WORLDWIDE RATES
    ...
    global $db;
      $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key in ('" . implode("', '", $this->keys()) . "')");
       $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key IN ( 'MODULE_SHIPPING_RMAMSMALLPACKET_ZONES_COUNTRIES_1', 'MODULE_SHIPPING_RMAMSMALLPACKET_ZONES_COUNTRIES_2') ");
    }
