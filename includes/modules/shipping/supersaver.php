...
class supersaver extends CommercePluginShippingBase {
    ...
    function install() {
      ...
      $gBitDb->Execute("insert into " . TABLE_CONFIGURATION . " (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `date_added`) values ('Maximum Cart Value', 'MODULE_SHIPPING_SUPERSAVER_MAX', '', 'What is the maximum cart total to get supersaver shipping?', '7', '6', now())");
      $gBitDb->Execute("insert into " . TABLE_CONFIGURATION . " (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `date_added`) values ('SuperSaver Shipping Cost', 'MODULE_SHIPPING_SUPERSAVER_DOMESTIC_COST', '4.99', 'What is the SuperSaver Shipping cost?', '7', '6', now())");
      ...
      $gBitDb->Execute("insert into " . TABLE_CONFIGURATION . " (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `date_added`) values ('International SuperSaver Shipping Description', 'MODULE_SHIPPING_SUPERSAVER_INTL_DESC', 'International SuperSaver', 'Text to accompany SuperSaver international quote', '7', '6', now())");
