<?
/*
  $Id: rm1stletter.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
  based upon
  $Id: rm1stletter.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
  based upon
  $Id: rm1stletter.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
      ...
      if ($dest_zone == 0) {
	   ...
	   //12 FEB 04 MBeedell	'glue' together the rates from the 10 cost data entry boxes
        ...
        if ($shipping == -1) {
          ...
          $shipping_cost = ($shipping * $shipping_num_boxes) + constant('MODULE_SHIPPING_RM1STLETTER_ZONES_HANDLING_' . $dest_zone);
        }
      }
...
//                            'module' => MODULE_SHIPPING_RM1STLETTER_TEXT_TITLE ,
    ...
    global $db;
      if (!isset($this->_check)) {
        $check_query = $db->Execute("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_SHIPPING_RM1STLETTER_STATUS'");
    ...
    global $db;
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_RM1STLETTER_SORT_ORDER', '0', 'Sort order of display.', '6', '0', now())");
    ...
    global $db;
      ...
      $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_SHIPPING_RM1STLETTER_ZONES_COUNTRIES_1'");
    }
