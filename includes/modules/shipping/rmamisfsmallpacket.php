<?
/*
  $Id: rmamisfsmallpacket.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
  based upon
  $Id: rmamisfsmallpacket.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
  based upon
  $Id: rmamisfsmallpacket.php,v 1.1 2006/11/01 19:12:17 lsces Exp $
...
// class constructor
    function rmamisfsmallpacket () {
      ...
      $this->icon = (( defined('DIR_WS_ICONS') ? DIR_WS_ICONS : 'images/icons/' ) . 'shipping_ukamisf.gif');
      ...
      if ($dest_zone == 0) {
	   ...
	   //12 FEB 04 MBeedell	'glue' together the rates from the 10 cost data entry boxes
        ...
        if ($shipping == -1) {
          ...
          $shipping_cost = ($shipping * $shipping_num_boxes) + constant('MODULE_SHIPPING_RMAMISFSMALLPACKET_ZONES_HANDLING_' . $dest_zone);
        }
      }
...
//                            'module' => MODULE_SHIPPING_RMAMISFSMALLPACKET_TEXT_TITLE ,
    ...
    global $db;
      if (!isset($this->_check)) {
        $check_query = $db->Execute("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_SHIPPING_RMAMISFSMALLPACKET_STATUS'");
    ...
    global $db;
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_RMAMISFSMALLPACKET_SORT_ORDER', '0', 'Sort order of display.', '6', '0', now())");
...
// WORLDWIDE RATES
    ...
    global $db;
      $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key in ('" . implode("', '", $this->keys()) . "')");
       $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key IN ( 'MODULE_SHIPPING_RMAMISFSMALLPACKET_ZONES_COUNTRIES_1', 'MODULE_SHIPPING_RMAMISFSMALLPACKET_ZONES_COUNTRIES_2') ");
    }
