			...
			if( !empty($arr_response['output']['rateReplyDetails']) ) {
				switch (SHIPPING_BOX_WEIGHT_DISPLAY) {
					...
					case (1):
						...
						break;
					case (2):
						$show_box_weight = ' (' . number_format($pShipHash['shipping_weight'] * $pShipHash['shipping_num_boxes'], 2) . TEXT_SHIPPING_WEIGHT . ')';
						break;
					default:
						$show_box_weight = ' (' . $pShipHash['shipping_num_boxes'] . ' x ' . number_format($pShipHash['shipping_weight_total'], 2) . TEXT_SHIPPING_WEIGHT . ')';
						break;
				}
