  ...
  if ($num_products_count > 0) {
    ...
    foreach( $new_products as $product ) {
      ...
      $listBoxContents[$row][$col] = array('align' => 'center',
                                             ...
                                             'text' => '<a href="' .  CommerceProduct::getDisplayUrlFromHash( $product['products_id'] ) . '">' . zen_image( $product['products_image_url'], $product['products_name'] ) . '</a><br /><a href="' . CommerceProduct::getDisplayUrlFromHash( $product['products_id'] ) . '">' . $product['products_name'] . '</a><br />' . $products_price);
